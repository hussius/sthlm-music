...
export { crawlTickster } from './tickster.js';
export { crawlRA } from './ra.js';
export { crawlTechnoiStockholm } from './technoistockholm.js';
...
export async function crawlAllVenues() {
  const crawlers = [
    ...
    { name: 'Tickster', fn: async () => (await import('./tickster.js')).crawlTickster() },
    { name: 'Resident Advisor', fn: async () => (await import('./ra.js')).crawlRA() },
    { name: 'Techno i Stockholm', fn: async () => (await import('./technoistockholm.js')).crawlTechnoiStockholm() },
