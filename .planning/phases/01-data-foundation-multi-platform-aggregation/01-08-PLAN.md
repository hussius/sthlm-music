...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 4: Verify complete job scheduling system</name>
  <files>N/A</files>
  <action>
Human verification checkpoint for the complete automated job scheduling system. All implementation is complete - this task verifies the system works end-to-end through manual testing.
...
Type "approved" when job scheduling system is verified working, or describe any issues found.
  ...
  <verify>
Manual human verification of system behavior - no automated verification possible.
  </verify>
  <done>
- Job scheduling system verified working by human
- All scheduled jobs executing correctly
- Monitoring and alerting operational
- Cleanup maintaining 12-month window
